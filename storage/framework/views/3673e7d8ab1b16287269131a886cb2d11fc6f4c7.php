  ...
  <div class="row">  
     ...
     <div class="col-lg-8">
      ...
      <div class="card mb-4" >
        ...
        <hr>
            <form method="POST" action="<?php echo e(route('bed-tracker.store')); ?>">
               <?php echo csrf_field(); ?>
               <div class="row">
              ...
              <div class="row">
                  ...
                  <div class="col-sm text-end "> 
                     <a href="<?php echo e(route('bed-tracker.index')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ohcc_system\resources\views/bed-tracker/add-hospital.blade.php ENDPATH**/ ?>